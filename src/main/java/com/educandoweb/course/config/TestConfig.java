...
public class TestConfig implements CommandLineRunner{ //Command necessário para implementar para executar a instanciação quando o programa for iniciado
	...
	public void run(String... args) throws Exception { //tudo que estiver dentro deste método vai ser executada quando a aplicação for iniciada
		...
		Category cat3 = new Category(null, "Computres");
		...
		p1.getCategories().add(cat2); //dizendo que o p1 é da categoria cat2(books)
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-20T21:53:07Z"), o1); //associei meu pedido 1 com o pagamento pay1
		o1.setPayment(pay1); //feito isso, mando salvar novamente o pedido (p1) e assim o JPA trata de salvar este pedido
